...
class VerifiedShopKeeper extends StatefulWidget {
  const VerifiedShopKeeper({Key? key}) : super(key: key);

  @override
  State<VerifiedShopKeeper> createState() => _VerifiedShopKeeperState();
}

class _VerifiedShopKeeperState extends State<VerifiedShopKeeper> {
  @override
        ...
        return InkWell(
          onTap: (){
            index==2?Provider.of<SideMenuProvider>(context, listen: false)
                ...
                .changeCurrentScreen(CustomScreensEnum.requestShopSkipperScreen):null;
          },
          child: Container(
  ...
  Widget shopkeeperList(){
    final Size _size = MediaQuery.of(context).size;
    return Column(
      children: [
        Row(
          children: [
            Text('Verified ShopKeeper List ',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w600,color: Colors.black))
          ],
        ),
        ...
        //       Expanded(
        //         flex: 1,
        //         child: Center(child: Text('No Of Product',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.white),)),
        //       ),
        //
        //       Expanded(
        //         flex: 1,
                          ...
                          DataCell(
                            Container(
                              constraints: BoxConstraints(
                                  maxWidth:Responsive.isMobile(context)? _size.width*0.5 : _size.width*0.15
                              ),
                              child: Padding(
                                padding: const EdgeInsets.only(left: 5),
                                child: Row(
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    child: Text('De-Activate',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,
                                        color:Colors.white
