...
class RequestSupplierScreen extends StatefulWidget {
  const RequestSupplierScreen({Key? key}) : super(key: key);

  @override
  State<RequestSupplierScreen> createState() => _RequestSupplierScreenState();
}

class _RequestSupplierScreenState extends State<RequestSupplierScreen> {
  @override
  ...
  var customerList = [
    ...
    'Deb Sarkar',
    'Deb Sarkar',
    'Deb  jkgds dviusdv jsduvb Sarkar',
    'Deb Sarkar',
  ...
  Widget supplierList(){
    ...
    return Column(
      children: [
        Row(
          children: [
            Text('Supplier Request List ',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w600,color: Colors.black))
          ],
        ),
              ...
              child: SingleChildScrollView(
                ...
                child: Align(
                  ...
                  child: DataTable(
                    ...
                    columns: [
                      DataColumn(
                        label: Text('Name',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.white),textAlign: TextAlign.center,),
                      ),
                      DataColumn(
                        numeric: true,
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Icon(Icons.cancel_outlined,color: Colors.white,size: _size.height*0.02,),
        ...
        //       Expanded(
        //         flex: 1,
        //         child: Center(child: Text('Number',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.white),textAlign: TextAlign.center,)),
        //       ),
        //       Expanded(
        //         flex: 2,
        //         child: Center(child: Text('Address',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.white),textAlign: TextAlign.center,)),
        //       ),
        //       Expanded(
        //         flex: 1,
        //         child: Text('No Of Product',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.white),textAlign: TextAlign.center,),
        //       ),
        //
        //       Expanded(
        //         flex: 1,
        //         child: Center(child: Text('Gst Number',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.white),textAlign: TextAlign.center,)),
        //       ),
        //       Expanded(
        //         flex: 1,
        //         child: Center(child: Text('Type',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.white),textAlign: TextAlign.center,)),
        //       ),
        //       Expanded(
        //         flex: 1,
        //         child: Center(child: Text('Action',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.white),textAlign: TextAlign.center,)),
        //       ),
        //     ],
        //   ),
        // ),
        ...
        //               flex: 1,
        //               child: Center(child:
        //               Text(dateList[index],style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.black),textAlign: TextAlign.center,)),
        //             ),
        //             Expanded(
        //               flex: 2,
        //               child: Center(child: Text('636, Arambagh, Hooghly-712601',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.black),textAlign: TextAlign.center,
        //
        //               )),
        //             ),
        //             Expanded(
        //               flex: 1,
        //               child: Center(child: Text(productList[index],style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.black),textAlign: TextAlign.center,)),
        //             ),
        //
        //             Expanded(
        //               flex: 1,
        //               child: Center(child: Text(' AYHD123456',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.black),textAlign: TextAlign.center,)),
        //             ),
        //             Expanded(
        //               flex: 1,
        //               child: Center(child: Text('Not Mention',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w500,color: Colors.black),textAlign: TextAlign.center,)),
        //             ),
        //
        //             Expanded(
        //               flex: 1,
