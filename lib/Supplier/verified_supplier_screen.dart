...
class VerifiedSupplierScreen extends StatefulWidget {
  const VerifiedSupplierScreen({Key? key}) : super(key: key);

  @override
  State<VerifiedSupplierScreen> createState() => _VerifiedSupplierScreenState();
}

class _VerifiedSupplierScreenState extends State<VerifiedSupplierScreen> {
  @override
  ...
  Widget supplierList(){
    ...
    return Column(
      children: [
        Row(
          children: [
            Text('Verified Supplier List ',style: TextStyle(fontSize: _size.height*0.02,fontWeight: FontWeight.w600,color: Colors.black))
          ],
        ),
